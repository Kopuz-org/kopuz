...
#[component]
pub fn MusicBrainzSettings(on_save: EventHandler<String>) -> Element {
...
pub fn LastFmSettings(
    /// Whether the daemon holds a usable Last.fm session.
    connected: bool,
...
#[component]
pub fn LibreFmSettings(connected: bool, on_connect: EventHandler<()>) -> Element {
    rsx! {
        div {
            class: "flex flex-col gap-3 w-full max-w-xl",
            button {
