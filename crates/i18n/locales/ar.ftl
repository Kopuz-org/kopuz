...
youtube_download_title = تنزيلات يوتيوب
youtube_download_subtitle = ابحث في YouTube Music بالاسم أو الصق رابطًا، ونزّل عبر Kopuz
youtube_download_options = الخيارات
youtube_download_search_placeholder = اسم الأغنية أو الفنان أو الألبوم، أو الصق رابطًا…
youtube_download_search = بحث
youtube_download_download_link = تنزيل الرابط
youtube_download_resolving_link = جارٍ قراءة الرابط…
youtube_download_link_detected = تم التعرف على رابط، سيُنزَّل هذا المقطع بالتحديد
youtube_download_error_link = تعذّرت قراءة الرابط: { $error }
youtube_download_searching = جارٍ البحث…
youtube_download_results = نتائج البحث
youtube_download_download = تنزيل
youtube_download_output_dir_placeholder = مجلد الحفظ (الافتراضي هو مجلد الموسيقى)
youtube_download_pick_folder = اختيار مجلد
youtube_download_clear_history = مسح السجل
youtube_download_empty_state = ابحث عن أغنية للبدء، أو الصق رابط يوتيوب
youtube_download_no_results = لم يُعثر على أغانٍ
youtube_download_jobs = التنزيلات
youtube_download_file_options = خيارات الملف
youtube_download_embed_metadata = تضمين البيانات الوصفية
youtube_download_embed_metadata_desc = حفظ العنوان والفنان والألبوم ورابط المصدر داخل الملف الصوتي
youtube_download_embed_thumbnail = تضمين صورة الغلاف
youtube_download_embed_thumbnail_desc = التضمين إن كانت الصيغة تدعمه، وإلا يُحفظ ملف JPG بجانبه
youtube_download_write_thumbnail = حفظ الغلاف بشكل منفصل
youtube_download_write_thumbnail_desc = كتابة ملف JPG بجوار الصوت المُنزَّل
youtube_download_organize_album = التنظيم حسب الألبوم
youtube_download_organize_album_desc = وضع التنزيلات في مجلد باسم الألبوم
youtube_download_overwrite = استبدال الملفات الموجودة
youtube_download_overwrite_desc = استبدال ملف يحمل الاسم نفسه
youtube_download_ffmpeg_hint = التنزيل بالجودة الأصلية لا يحتاج إلى أي برنامج خارجي. ffmpeg مطلوب فقط للتحويل أو البيانات الوصفية أو الغلاف المضمَّن.
youtube_download_format_original = الجودة الأصلية
...
youtube_download_status_resolving = جارٍ تحديد بث يوتيوب…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  يتبقى { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = جارٍ المعالجة…
youtube_download_status_completed = اكتمل
youtube_download_status_waiting = في الانتظار…
youtube_download_error_search = فشل البحث: { $error }
youtube_download_error_ffmpeg_required = هذه الصيغة أو خيارات الملف المختارة تحتاج إلى ffmpeg. ثبّت ffmpeg أو اختر الجودة الأصلية وعطّل التضمين.
youtube_download_error_duplicate_active = هذه الأغنية قيد التنزيل بالفعل.
youtube_download_error_output_not_directory = مسار الحفظ ليس مجلدًا: { $path }
youtube_download_error_output_prepare = تعذّر تجهيز مجلد الحفظ: { $error }
youtube_download_error_output_not_writable = لا يمكن الكتابة في مجلد الحفظ: { $path }
