...
youtube_download_subtitle = YouTube Music nach Namen durchsuchen oder einen Link einfügen und mit Kopuz herunterladen
youtube_download_options = Optionen
youtube_download_search_placeholder = Titel, Interpret oder Album, oder einen Link einfügen…
youtube_download_search = Suchen
youtube_download_download_link = Link herunterladen
youtube_download_resolving_link = Link wird gelesen…
youtube_download_link_detected = Link erkannt, genau dieser Titel wird geladen
youtube_download_error_link = Link konnte nicht gelesen werden: { $error }
youtube_download_searching = Suche läuft…
youtube_download_results = Suchergebnisse
youtube_download_download = Herunterladen
youtube_download_output_dir_placeholder = Zielordner (standardmäßig der Musikordner)
youtube_download_pick_folder = Ordner wählen
youtube_download_clear_history = Verlauf löschen
youtube_download_empty_state = Suche nach einem Titel oder füge einen YouTube-Link ein
youtube_download_no_results = Keine Titel gefunden
youtube_download_jobs = Downloads
youtube_download_file_options = Dateioptionen
youtube_download_embed_metadata = Metadaten einbetten
youtube_download_embed_metadata_desc = Titel, Interpret, Album und Quell-URL in der Audiodatei speichern
youtube_download_embed_thumbnail = Cover einbetten
youtube_download_embed_thumbnail_desc = Einbetten, wenn das Format es unterstützt, sonst als JPG daneben speichern
youtube_download_write_thumbnail = Cover separat speichern
youtube_download_write_thumbnail_desc = Ein JPG neben der geladenen Audiodatei ablegen
youtube_download_organize_album = Nach Album sortieren
youtube_download_organize_album_desc = Downloads in einen Ordner mit dem Albumnamen legen
youtube_download_overwrite = Vorhandene Dateien überschreiben
youtube_download_overwrite_desc = Eine Datei mit demselben Zielnamen ersetzen
youtube_download_ffmpeg_hint = Downloads in Originalqualität brauchen kein externes Programm. ffmpeg wird nur für Konvertierung, Metadaten oder eingebettete Cover benötigt.
youtube_download_format_original = Originalqualität
...
youtube_download_status_resolving = YouTube-Stream wird aufgelöst…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  noch { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Wird verarbeitet…
youtube_download_status_completed = Abgeschlossen
youtube_download_status_waiting = Wartet…
youtube_download_error_search = Suche fehlgeschlagen: { $error }
youtube_download_error_ffmpeg_required = Für dieses Format oder die gewählten Dateioptionen wird ffmpeg benötigt. Installiere ffmpeg oder wähle Originalqualität und deaktiviere das Einbetten.
youtube_download_error_duplicate_active = Dieser Titel wird bereits geladen.
youtube_download_error_output_not_directory = Der Zielpfad ist kein Ordner: { $path }
youtube_download_error_output_prepare = Zielordner konnte nicht vorbereitet werden: { $error }
youtube_download_error_output_not_writable = Der Zielordner ist nicht beschreibbar: { $path }
