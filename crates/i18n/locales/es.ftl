...
server = Servidor
youtube_downloads = Descargas
youtube_download_title = Descargas de YouTube
youtube_download_subtitle = Busca en YouTube Music por nombre o pega un enlace, y descarga con Kopuz
youtube_download_options = Opciones
youtube_download_search_placeholder = Título, artista o álbum, o pega un enlace…
youtube_download_search = Buscar
youtube_download_download_link = Descargar enlace
youtube_download_resolving_link = Leyendo el enlace…
youtube_download_link_detected = Enlace detectado, esto descarga exactamente esa pista
youtube_download_error_link = No se pudo leer ese enlace: { $error }
youtube_download_searching = Buscando…
youtube_download_results = Resultados de la búsqueda
youtube_download_download = Descargar
youtube_download_output_dir_placeholder = Carpeta de destino (por defecto, la carpeta de música)
youtube_download_pick_folder = Elegir carpeta
youtube_download_clear_history = Borrar historial
youtube_download_empty_state = Busca una canción para empezar, o pega un enlace de YouTube
youtube_download_no_results = No se encontraron canciones
youtube_download_jobs = Descargas
youtube_download_file_options = Opciones de archivo
youtube_download_embed_metadata = Incrustar metadatos
youtube_download_embed_metadata_desc = Guardar título, artista, álbum y URL de origen en el archivo de audio
youtube_download_embed_thumbnail = Incrustar la carátula
youtube_download_embed_thumbnail_desc = Incrustar si el formato lo permite; si no, guardar un JPG aparte
youtube_download_write_thumbnail = Guardar la carátula por separado
youtube_download_write_thumbnail_desc = Escribir un JPG junto al audio descargado
youtube_download_organize_album = Organizar por álbum
youtube_download_organize_album_desc = Poner las descargas en una carpeta con el nombre del álbum
youtube_download_overwrite = Sobrescribir archivos existentes
youtube_download_overwrite_desc = Reemplazar un archivo con el mismo nombre de salida
youtube_download_ffmpeg_hint = Las descargas en calidad original no necesitan ningún descargador externo. ffmpeg solo hace falta para convertir, para los metadatos o para la carátula incrustada.
youtube_download_format_original = Calidad original
...
youtube_download_status_resolving = Resolviendo el flujo de YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  faltan { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Procesando…
youtube_download_status_completed = Completada
youtube_download_status_waiting = En espera…
youtube_download_error_search = La búsqueda falló: { $error }
youtube_download_error_ffmpeg_required = Este formato o las opciones de archivo elegidas necesitan ffmpeg. Instala ffmpeg o elige calidad original y desactiva la incrustación.
youtube_download_error_duplicate_active = Esta canción ya se está descargando.
youtube_download_error_output_not_directory = La ruta de destino no es una carpeta: { $path }
youtube_download_error_output_prepare = No se pudo preparar la carpeta de destino: { $error }
youtube_download_error_output_not_writable = No se puede escribir en la carpeta de destino: { $path }
