...
server = Serveur
youtube_downloads = Téléchargements
youtube_download_title = Téléchargements YouTube
youtube_download_subtitle = Cherchez sur YouTube Music par nom ou collez un lien, et téléchargez avec Kopuz
youtube_download_options = Options
youtube_download_search_placeholder = Titre, artiste ou album, ou collez un lien…
youtube_download_search = Rechercher
youtube_download_download_link = Télécharger le lien
youtube_download_resolving_link = Lecture du lien…
youtube_download_link_detected = Lien détecté, ceci télécharge exactement ce morceau
youtube_download_error_link = Impossible de lire ce lien : { $error }
youtube_download_searching = Recherche…
youtube_download_results = Résultats de recherche
youtube_download_download = Télécharger
youtube_download_output_dir_placeholder = Dossier de destination (par défaut, le dossier musique)
youtube_download_pick_folder = Choisir un dossier
youtube_download_clear_history = Effacer l'historique
youtube_download_empty_state = Cherchez un morceau pour commencer, ou collez un lien YouTube
youtube_download_no_results = Aucun morceau trouvé
youtube_download_jobs = Téléchargements
youtube_download_file_options = Options de fichier
youtube_download_embed_metadata = Intégrer les métadonnées
youtube_download_embed_metadata_desc = Enregistrer le titre, l'artiste, l'album et l'URL source dans le fichier audio
youtube_download_embed_thumbnail = Intégrer la pochette
youtube_download_embed_thumbnail_desc = Intégrer si le format le permet, sinon enregistrer un JPG à côté
youtube_download_write_thumbnail = Enregistrer la pochette séparément
youtube_download_write_thumbnail_desc = Écrire un JPG à côté de l'audio téléchargé
youtube_download_organize_album = Classer par album
youtube_download_organize_album_desc = Placer les téléchargements dans un dossier au nom de l'album
youtube_download_overwrite = Écraser les fichiers existants
youtube_download_overwrite_desc = Remplacer un fichier portant le même nom de sortie
youtube_download_ffmpeg_hint = Les téléchargements en qualité originale ne demandent aucun téléchargeur externe. ffmpeg ne sert qu'à la conversion, aux métadonnées ou à la pochette intégrée.
youtube_download_format_original = Qualité originale
...
youtube_download_status_resolving = Résolution du flux YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  reste { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Traitement…
youtube_download_status_completed = Terminé
youtube_download_status_waiting = En attente…
youtube_download_error_search = Échec de la recherche : { $error }
youtube_download_error_ffmpeg_required = Ce format ou les options de fichier choisies nécessitent ffmpeg. Installez ffmpeg, ou choisissez la qualité originale et désactivez l'intégration.
youtube_download_error_duplicate_active = Ce morceau est déjà en cours de téléchargement.
youtube_download_error_output_not_directory = Le chemin de destination n'est pas un dossier : { $path }
youtube_download_error_output_prepare = Échec de la préparation du dossier de destination : { $error }
youtube_download_error_output_not_writable = Le dossier de destination n'est pas accessible en écriture : { $path }
