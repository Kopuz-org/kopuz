...
remove_from_queue = Αφαίρεση από την Ουρά
go_to_artist = Μετάβαση στον Καλλιτέχνη
go_to_album = Μετάβαση στο Άλμπουμ
download_offline = Λήψη Εκτός Σύνδεσης
remove_download = Αφαίρεση Λήψης
downloading = Γίνεται λήψη…
more_actions_for = Περισσότερες ενέργειες για { $name }
