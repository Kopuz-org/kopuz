...
server = Διακομιστής
youtube_downloads = Λήψεις
youtube_download_title = Λήψεις YouTube
youtube_download_subtitle = Αναζήτησε στο YouTube Music με το όνομα ή επικόλλησε έναν σύνδεσμο, και κατέβασέ το με το Kopuz
youtube_download_options = Επιλογές
youtube_download_search_placeholder = Τίτλος, καλλιτέχνης ή άλμπουμ, ή επικόλλησε έναν σύνδεσμο…
youtube_download_search = Αναζήτηση
youtube_download_download_link = Λήψη συνδέσμου
youtube_download_resolving_link = Ανάγνωση συνδέσμου…
youtube_download_link_detected = Εντοπίστηκε σύνδεσμος, κατεβαίνει ακριβώς αυτό το κομμάτι
youtube_download_error_link = Δεν ήταν δυνατή η ανάγνωση του συνδέσμου: { $error }
youtube_download_searching = Αναζήτηση…
youtube_download_results = Αποτελέσματα αναζήτησης
youtube_download_download = Λήψη
youtube_download_output_dir_placeholder = Φάκελος προορισμού (προεπιλογή: ο φάκελος μουσικής)
youtube_download_pick_folder = Επιλογή φακέλου
youtube_download_clear_history = Καθαρισμός ιστορικού
youtube_download_empty_state = Αναζήτησε ένα τραγούδι για να ξεκινήσεις, ή επικόλλησε έναν σύνδεσμο YouTube
youtube_download_no_results = Δεν βρέθηκαν τραγούδια
youtube_download_jobs = Λήψεις
youtube_download_file_options = Επιλογές αρχείου
youtube_download_embed_metadata = Ενσωμάτωση μεταδεδομένων
youtube_download_embed_metadata_desc = Αποθήκευση τίτλου, καλλιτέχνη, άλμπουμ και διεύθυνσης πηγής στο αρχείο ήχου
youtube_download_embed_thumbnail = Ενσωμάτωση εξωφύλλου
youtube_download_embed_thumbnail_desc = Ενσωμάτωση όταν το υποστηρίζει η μορφή, αλλιώς αποθήκευση JPG δίπλα
youtube_download_write_thumbnail = Ξεχωριστή αποθήκευση εξωφύλλου
youtube_download_write_thumbnail_desc = Γράψε ένα JPG δίπλα στο αρχείο ήχου που κατέβηκε
youtube_download_organize_album = Οργάνωση κατά άλμπουμ
youtube_download_organize_album_desc = Τοποθέτηση των λήψεων σε φάκελο με το όνομα του άλμπουμ
youtube_download_overwrite = Αντικατάσταση υπαρχόντων αρχείων
youtube_download_overwrite_desc = Αντικατάσταση αρχείου με το ίδιο τελικό όνομα
youtube_download_ffmpeg_hint = Οι λήψεις σε αρχική ποιότητα δεν χρειάζονται εξωτερικό πρόγραμμα. Το ffmpeg απαιτείται μόνο για μετατροπή, μεταδεδομένα ή ενσωματωμένο εξώφυλλο.
youtube_download_format_original = Αρχική ποιότητα
...
youtube_download_status_resolving = Εντοπισμός ροής YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  απομένουν { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Επεξεργασία…
youtube_download_status_completed = Ολοκληρώθηκε
youtube_download_status_waiting = Αναμονή…
youtube_download_error_search = Η αναζήτηση απέτυχε: { $error }
youtube_download_error_ffmpeg_required = Αυτή η μορφή ή οι επιλογές αρχείου που διάλεξες απαιτούν ffmpeg. Εγκατέστησε το ffmpeg ή διάλεξε αρχική ποιότητα και απενεργοποίησε την ενσωμάτωση.
youtube_download_error_duplicate_active = Αυτό το τραγούδι κατεβαίνει ήδη.
youtube_download_error_output_not_directory = Η διαδρομή προορισμού δεν είναι φάκελος: { $path }
youtube_download_error_output_prepare = Απέτυχε η προετοιμασία του φακέλου προορισμού: { $error }
youtube_download_error_output_not_writable = Ο φάκελος προορισμού δεν είναι εγγράψιμος: { $path }
