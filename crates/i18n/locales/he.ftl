...
server = שרת
youtube_downloads = הורדות
youtube_download_title = הורדות מיוטיוב
youtube_download_subtitle = חפשו ב-YouTube Music לפי שם או הדביקו קישור, והורידו עם Kopuz
youtube_download_options = אפשרויות
youtube_download_search_placeholder = שם השיר, האמן או האלבום, או הדביקו קישור…
youtube_download_search = חיפוש
youtube_download_download_link = הורדת הקישור
youtube_download_resolving_link = קורא את הקישור…
youtube_download_link_detected = זוהה קישור, זה יוריד בדיוק את הרצועה הזו
youtube_download_error_link = לא ניתן היה לקרוא את הקישור: { $error }
youtube_download_searching = מחפש…
youtube_download_results = תוצאות חיפוש
youtube_download_download = הורדה
youtube_download_output_dir_placeholder = תיקיית יעד (ברירת המחדל היא תיקיית המוזיקה)
youtube_download_pick_folder = בחירת תיקייה
youtube_download_clear_history = ניקוי היסטוריה
youtube_download_empty_state = חפשו שיר כדי להתחיל, או הדביקו קישור יוטיוב
youtube_download_no_results = לא נמצאו שירים
youtube_download_jobs = הורדות
youtube_download_file_options = אפשרויות קובץ
youtube_download_embed_metadata = הטמעת מטא-נתונים
youtube_download_embed_metadata_desc = שמירת שם, אמן, אלבום וכתובת המקור בתוך קובץ השמע
youtube_download_embed_thumbnail = הטמעת תמונת עטיפה
youtube_download_embed_thumbnail_desc = הטמעה כשהפורמט תומך בכך, אחרת שמירת JPG לצידו
youtube_download_write_thumbnail = שמירת העטיפה בנפרד
youtube_download_write_thumbnail_desc = כתיבת קובץ JPG לצד השמע שהורד
youtube_download_organize_album = סידור לפי אלבום
youtube_download_organize_album_desc = לשים את ההורדות בתיקייה בשם האלבום
youtube_download_overwrite = דריסת קבצים קיימים
youtube_download_overwrite_desc = החלפת קובץ בעל אותו שם יעד
youtube_download_ffmpeg_hint = הורדות באיכות המקורית אינן דורשות תוכנת הורדה חיצונית. ffmpeg נדרש רק להמרה, למטא-נתונים או לעטיפה מוטמעת.
youtube_download_format_original = איכות מקורית
...
youtube_download_status_resolving = מאתר את שידור היוטיוב…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  נותרו { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = מעבד…
youtube_download_status_completed = הושלם
youtube_download_status_waiting = ממתין…
youtube_download_error_search = החיפוש נכשל: { $error }
youtube_download_error_ffmpeg_required = הפורמט הזה או אפשרויות הקובץ שנבחרו דורשים ffmpeg. התקינו ffmpeg, או בחרו איכות מקורית וכבו את ההטמעה.
youtube_download_error_duplicate_active = השיר הזה כבר בהורדה.
youtube_download_error_output_not_directory = נתיב היעד אינו תיקייה: { $path }
youtube_download_error_output_prepare = הכנת תיקיית היעד נכשלה: { $error }
youtube_download_error_output_not_writable = לא ניתן לכתוב לתיקיית היעד: { $path }
