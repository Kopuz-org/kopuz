...
server = Szerver
youtube_downloads = Letöltések
youtube_download_title = YouTube-letöltések
youtube_download_subtitle = Keress a YouTube Musicban név szerint, vagy illessz be egy hivatkozást, és töltsd le a Kopuzzal
youtube_download_options = Beállítások
youtube_download_search_placeholder = Cím, előadó vagy album, vagy illessz be egy hivatkozást…
youtube_download_search = Keresés
youtube_download_download_link = Hivatkozás letöltése
youtube_download_resolving_link = Hivatkozás olvasása…
youtube_download_link_detected = Hivatkozás észlelve, pontosan azt a számot tölti le
youtube_download_error_link = Nem sikerült beolvasni a hivatkozást: { $error }
youtube_download_searching = Keresés…
youtube_download_results = Találatok
youtube_download_download = Letöltés
youtube_download_output_dir_placeholder = Célmappa (alapértelmezetten a zenemappa)
youtube_download_pick_folder = Mappa választása
youtube_download_clear_history = Előzmények törlése
youtube_download_empty_state = Keress egy számot a kezdéshez, vagy illessz be egy YouTube-hivatkozást
youtube_download_no_results = Nem található szám
youtube_download_jobs = Letöltések
youtube_download_file_options = Fájlbeállítások
youtube_download_embed_metadata = Metaadatok beágyazása
youtube_download_embed_metadata_desc = Cím, előadó, album és forrás-URL mentése a hangfájlba
youtube_download_embed_thumbnail = Borító beágyazása
youtube_download_embed_thumbnail_desc = Beágyazás, ha a formátum támogatja, különben JPG mentése mellé
youtube_download_write_thumbnail = Borító mentése külön
youtube_download_write_thumbnail_desc = JPG írása a letöltött hangfájl mellé
youtube_download_organize_album = Rendezés album szerint
youtube_download_organize_album_desc = A letöltések album nevű mappába kerüljenek
youtube_download_overwrite = Meglévő fájlok felülírása
youtube_download_overwrite_desc = Az azonos nevű célfájl cseréje
youtube_download_ffmpeg_hint = Az eredeti minőségű letöltéshez nem kell külső letöltő. Az ffmpeg csak átalakításhoz, metaadatokhoz vagy beágyazott borítóhoz kell.
youtube_download_format_original = Eredeti minőség
...
youtube_download_status_resolving = YouTube-adatfolyam feloldása…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  hátra { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Feldolgozás…
youtube_download_status_completed = Kész
youtube_download_status_waiting = Várakozás…
youtube_download_error_search = A keresés nem sikerült: { $error }
youtube_download_error_ffmpeg_required = Ehhez a formátumhoz vagy a kiválasztott fájlbeállításokhoz ffmpeg kell. Telepítsd az ffmpeget, vagy válaszd az eredeti minőséget és kapcsold ki a beágyazást.
youtube_download_error_duplicate_active = Ez a szám már letöltés alatt áll.
youtube_download_error_output_not_directory = A célútvonal nem mappa: { $path }
youtube_download_error_output_prepare = Nem sikerült előkészíteni a célmappát: { $error }
youtube_download_error_output_not_writable = A célmappa nem írható: { $path }
