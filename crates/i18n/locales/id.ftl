...
youtube_download_title = Unduhan YouTube
youtube_download_subtitle = Cari di YouTube Music berdasarkan nama atau tempel tautan, lalu unduh dengan Kopuz
youtube_download_options = Opsi
youtube_download_search_placeholder = Judul, artis, atau album, atau tempel tautan…
youtube_download_search = Cari
youtube_download_download_link = Unduh tautan
youtube_download_resolving_link = Membaca tautan…
youtube_download_link_detected = Tautan terdeteksi, ini mengunduh lagu itu persis
youtube_download_error_link = Tidak bisa membaca tautan itu: { $error }
youtube_download_searching = Mencari…
youtube_download_results = Hasil pencarian
youtube_download_download = Unduh
youtube_download_output_dir_placeholder = Folder tujuan (bawaan: folder musik)
youtube_download_pick_folder = Pilih folder
youtube_download_clear_history = Hapus riwayat
youtube_download_empty_state = Cari sebuah lagu untuk mulai, atau tempel tautan YouTube
youtube_download_no_results = Tidak ada lagu ditemukan
youtube_download_jobs = Unduhan
youtube_download_file_options = Opsi berkas
youtube_download_embed_metadata = Sematkan metadata
youtube_download_embed_metadata_desc = Simpan judul, artis, album, dan URL sumber di dalam berkas audio
youtube_download_embed_thumbnail = Sematkan sampul
youtube_download_embed_thumbnail_desc = Sematkan bila formatnya mendukung, jika tidak simpan JPG di sebelahnya
youtube_download_write_thumbnail = Simpan sampul terpisah
youtube_download_write_thumbnail_desc = Tulis berkas JPG di samping audio yang diunduh
youtube_download_organize_album = Susun menurut album
youtube_download_organize_album_desc = Taruh unduhan dalam folder bernama album
youtube_download_overwrite = Timpa berkas yang sudah ada
youtube_download_overwrite_desc = Ganti berkas dengan nama keluaran yang sama
youtube_download_ffmpeg_hint = Unduhan kualitas asli tidak butuh pengunduh eksternal. ffmpeg hanya diperlukan untuk konversi, metadata, atau sampul yang disematkan.
youtube_download_format_original = Kualitas asli
...
youtube_download_status_resolving = Menyiapkan aliran YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  sisa { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Memproses…
youtube_download_status_completed = Selesai
youtube_download_status_waiting = Menunggu…
youtube_download_error_search = Pencarian gagal: { $error }
youtube_download_error_ffmpeg_required = Format ini atau opsi berkas yang dipilih memerlukan ffmpeg. Pasang ffmpeg, atau pilih kualitas asli dan matikan penyematan.
youtube_download_error_duplicate_active = Lagu ini sedang diunduh.
youtube_download_error_output_not_directory = Jalur tujuan bukan folder: { $path }
youtube_download_error_output_prepare = Gagal menyiapkan folder tujuan: { $error }
youtube_download_error_output_not_writable = Folder tujuan tidak bisa ditulisi: { $path }
