...
server = Serwer
youtube_downloads = Pobrane
youtube_download_title = Pobieranie z YouTube
youtube_download_subtitle = Szukaj w YouTube Music po nazwie albo wklej link, i pobieraj przez Kopuz
youtube_download_options = Opcje
youtube_download_search_placeholder = Tytuł, wykonawca lub album, albo wklej link…
youtube_download_search = Szukaj
youtube_download_download_link = Pobierz link
youtube_download_resolving_link = Odczytywanie linku…
youtube_download_link_detected = Wykryto link, pobierze dokładnie ten utwór
youtube_download_error_link = Nie udało się odczytać linku: { $error }
youtube_download_searching = Szukanie…
youtube_download_results = Wyniki wyszukiwania
youtube_download_download = Pobierz
youtube_download_output_dir_placeholder = Folder docelowy (domyślnie folder z muzyką)
youtube_download_pick_folder = Wybierz folder
youtube_download_clear_history = Wyczyść historię
youtube_download_empty_state = Wyszukaj utwór, żeby zacząć, albo wklej link z YouTube
youtube_download_no_results = Nie znaleziono utworów
youtube_download_jobs = Pobrane
youtube_download_file_options = Opcje pliku
youtube_download_embed_metadata = Osadzaj metadane
youtube_download_embed_metadata_desc = Zapisuj tytuł, wykonawcę, album i adres źródła w pliku dźwiękowym
youtube_download_embed_thumbnail = Osadzaj okładkę
youtube_download_embed_thumbnail_desc = Osadzaj, gdy format to obsługuje, w przeciwnym razie zapisz JPG obok
youtube_download_write_thumbnail = Zapisuj okładkę osobno
youtube_download_write_thumbnail_desc = Zapisz plik JPG obok pobranego dźwięku
youtube_download_organize_album = Porządkuj według albumu
youtube_download_organize_album_desc = Umieszczaj pobrane pliki w folderze o nazwie albumu
youtube_download_overwrite = Nadpisuj istniejące pliki
youtube_download_overwrite_desc = Zastąp plik o tej samej nazwie docelowej
youtube_download_ffmpeg_hint = Pobieranie w oryginalnej jakości nie wymaga zewnętrznego programu. ffmpeg jest potrzebny tylko do konwersji, metadanych lub osadzonej okładki.
youtube_download_format_original = Oryginalna jakość
...
youtube_download_status_resolving = Ustalanie strumienia YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  pozostało { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Przetwarzanie…
youtube_download_status_completed = Ukończono
youtube_download_status_waiting = Oczekiwanie…
youtube_download_error_search = Wyszukiwanie nie powiodło się: { $error }
youtube_download_error_ffmpeg_required = Ten format lub wybrane opcje pliku wymagają ffmpeg. Zainstaluj ffmpeg albo wybierz oryginalną jakość i wyłącz osadzanie.
youtube_download_error_duplicate_active = Ten utwór już się pobiera.
youtube_download_error_output_not_directory = Ścieżka docelowa nie jest folderem: { $path }
youtube_download_error_output_prepare = Nie udało się przygotować folderu docelowego: { $error }
youtube_download_error_output_not_writable = Nie można zapisywać w folderze docelowym: { $path }
