...
youtube_download_title = Downloads do YouTube
youtube_download_subtitle = Pesquise no YouTube Music pelo nome ou cole um link, e baixe com o Kopuz
youtube_download_options = Opções
youtube_download_search_placeholder = Título, artista ou álbum, ou cole um link…
youtube_download_search = Pesquisar
youtube_download_download_link = Baixar link
youtube_download_resolving_link = Lendo o link…
youtube_download_link_detected = Link detectado, isto baixa exatamente essa faixa
youtube_download_error_link = Não foi possível ler esse link: { $error }
youtube_download_searching = Pesquisando…
youtube_download_results = Resultados da pesquisa
youtube_download_download = Baixar
youtube_download_output_dir_placeholder = Pasta de destino (padrão: a pasta de músicas)
youtube_download_pick_folder = Escolher pasta
youtube_download_clear_history = Limpar histórico
youtube_download_empty_state = Pesquise uma música para começar, ou cole um link do YouTube
youtube_download_no_results = Nenhuma música encontrada
youtube_download_jobs = Downloads
youtube_download_file_options = Opções de arquivo
youtube_download_embed_metadata = Incorporar metadados
youtube_download_embed_metadata_desc = Salvar título, artista, álbum e URL de origem no arquivo de áudio
youtube_download_embed_thumbnail = Incorporar a capa
youtube_download_embed_thumbnail_desc = Incorporar quando o formato permitir; caso contrário, salvar um JPG ao lado
youtube_download_write_thumbnail = Salvar a capa separadamente
youtube_download_write_thumbnail_desc = Gravar um JPG ao lado do áudio baixado
youtube_download_organize_album = Organizar por álbum
youtube_download_organize_album_desc = Colocar os downloads em uma pasta com o nome do álbum
youtube_download_overwrite = Substituir arquivos existentes
youtube_download_overwrite_desc = Substituir um arquivo com o mesmo nome de saída
youtube_download_ffmpeg_hint = Downloads em qualidade original não precisam de nenhum baixador externo. O ffmpeg só é necessário para conversão, metadados ou capa incorporada.
youtube_download_format_original = Qualidade original
...
youtube_download_status_resolving = Resolvendo o fluxo do YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  faltam { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Processando…
youtube_download_status_completed = Concluído
youtube_download_status_waiting = Aguardando…
youtube_download_error_search = A pesquisa falhou: { $error }
youtube_download_error_ffmpeg_required = Este formato ou as opções de arquivo escolhidas exigem o ffmpeg. Instale o ffmpeg ou escolha qualidade original e desative a incorporação.
youtube_download_error_duplicate_active = Esta música já está sendo baixada.
youtube_download_error_output_not_directory = O caminho de destino não é uma pasta: { $path }
youtube_download_error_output_prepare = Falha ao preparar a pasta de destino: { $error }
youtube_download_error_output_not_writable = Não é possível gravar na pasta de destino: { $path }
