...
go_to_artist = Mergi la Artist
go_to_album = Mergi la Album
download_offline = Descarcă Offline
remove_download = Elimină Descărcarea
downloading = Se descarcă…
more_actions_for = Mai multe acțiuni pentru { $name }
