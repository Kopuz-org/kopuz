...
server = Server
youtube_downloads = Descărcări
youtube_download_title = Descărcări YouTube
youtube_download_subtitle = Caută pe YouTube Music după nume sau lipește un link, și descarcă cu Kopuz
youtube_download_options = Opțiuni
youtube_download_search_placeholder = Titlu, artist sau album, ori lipește un link…
youtube_download_search = Caută
youtube_download_download_link = Descarcă linkul
youtube_download_resolving_link = Se citește linkul…
youtube_download_link_detected = Link detectat, descarcă exact piesa aceea
youtube_download_error_link = Linkul nu a putut fi citit: { $error }
youtube_download_searching = Se caută…
youtube_download_results = Rezultatele căutării
youtube_download_download = Descarcă
youtube_download_output_dir_placeholder = Dosarul de destinație (implicit, dosarul de muzică)
youtube_download_pick_folder = Alege dosarul
youtube_download_clear_history = Șterge istoricul
youtube_download_empty_state = Caută o piesă ca să începi, sau lipește un link YouTube
youtube_download_no_results = Nu s-a găsit nicio piesă
youtube_download_jobs = Descărcări
youtube_download_file_options = Opțiuni de fișier
youtube_download_embed_metadata = Include metadatele
youtube_download_embed_metadata_desc = Salvează titlul, artistul, albumul și adresa sursă în fișierul audio
youtube_download_embed_thumbnail = Include coperta
youtube_download_embed_thumbnail_desc = Include coperta dacă formatul permite, altfel salveaz-o ca JPG alături
youtube_download_write_thumbnail = Salvează coperta separat
youtube_download_write_thumbnail_desc = Scrie un JPG lângă fișierul audio descărcat
youtube_download_organize_album = Organizează după album
youtube_download_organize_album_desc = Pune descărcările într-un dosar cu numele albumului
youtube_download_overwrite = Suprascrie fișierele existente
youtube_download_overwrite_desc = Înlocuiește un fișier cu același nume de ieșire
youtube_download_ffmpeg_hint = Descărcările în calitate originală nu au nevoie de niciun descărcător extern. ffmpeg este necesar doar pentru conversie, metadate sau coperta inclusă.
youtube_download_format_original = Calitate originală
...
youtube_download_status_resolving = Se rezolvă fluxul YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  au rămas { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Se procesează…
youtube_download_status_completed = Finalizat
youtube_download_status_waiting = În așteptare…
youtube_download_error_search = Căutarea a eșuat: { $error }
youtube_download_error_ffmpeg_required = Acest format sau opțiunile de fișier alese necesită ffmpeg. Instalează ffmpeg sau alege calitatea originală și dezactivează includerea.
youtube_download_error_duplicate_active = Piesa aceasta se descarcă deja.
youtube_download_error_output_not_directory = Calea de destinație nu este un dosar: { $path }
youtube_download_error_output_prepare = Dosarul de destinație nu a putut fi pregătit: { $error }
youtube_download_error_output_not_writable = Nu se poate scrie în dosarul de destinație: { $path }
