...
server = Сервер
youtube_downloads = Загрузки
youtube_download_title = Загрузки с YouTube
youtube_download_subtitle = Искать в YouTube Music по названию или вставить ссылку, и скачать через Kopuz
youtube_download_options = Параметры
youtube_download_search_placeholder = Название, исполнитель или альбом, либо вставьте ссылку…
youtube_download_search = Найти
youtube_download_download_link = Скачать по ссылке
youtube_download_resolving_link = Читаем ссылку…
youtube_download_link_detected = Обнаружена ссылка, будет скачан именно этот трек
youtube_download_error_link = Не удалось прочитать ссылку: { $error }
youtube_download_searching = Поиск…
youtube_download_results = Результаты поиска
youtube_download_download = Скачать
youtube_download_output_dir_placeholder = Папка назначения (по умолчанию папка с музыкой)
youtube_download_pick_folder = Выбрать папку
youtube_download_clear_history = Очистить историю
youtube_download_empty_state = Найдите песню, чтобы начать, или вставьте ссылку на YouTube
youtube_download_no_results = Песни не найдены
youtube_download_jobs = Загрузки
youtube_download_file_options = Параметры файла
youtube_download_embed_metadata = Встраивать метаданные
youtube_download_embed_metadata_desc = Сохранять название, исполнителя, альбом и адрес источника в аудиофайле
youtube_download_embed_thumbnail = Встраивать обложку
youtube_download_embed_thumbnail_desc = Встраивать, если формат поддерживает, иначе сохранять JPG рядом
youtube_download_write_thumbnail = Сохранять обложку отдельно
youtube_download_write_thumbnail_desc = Записывать JPG рядом со скачанным аудио
youtube_download_organize_album = Раскладывать по альбомам
youtube_download_organize_album_desc = Складывать загрузки в папку с названием альбома
youtube_download_overwrite = Перезаписывать существующие файлы
youtube_download_overwrite_desc = Заменять файл с таким же итоговым именем
youtube_download_ffmpeg_hint = Для загрузок в исходном качестве внешние программы не нужны. ffmpeg требуется только для конвертации, метаданных или встроенной обложки.
youtube_download_format_original = Исходное качество
...
youtube_download_status_resolving = Получаем поток YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  осталось { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Обработка…
youtube_download_status_completed = Готово
youtube_download_status_waiting = Ожидание…
youtube_download_error_search = Поиск не удался: { $error }
youtube_download_error_ffmpeg_required = Для этого формата или выбранных параметров файла нужен ffmpeg. Установите ffmpeg либо выберите исходное качество и отключите встраивание.
youtube_download_error_duplicate_active = Эта песня уже загружается.
youtube_download_error_output_not_directory = Путь назначения не является папкой: { $path }
youtube_download_error_output_prepare = Не удалось подготовить папку назначения: { $error }
youtube_download_error_output_not_writable = В папку назначения нельзя записывать: { $path }
