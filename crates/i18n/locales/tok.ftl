...
server = tan pana
youtube_downloads = kama jo
youtube_download_title = kama jo tan YouTube
youtube_download_subtitle = o alasa e nimi lon YouTube Music, anu o pana e linja nimi. Kopuz li kama jo e ona
youtube_download_options = nasin ante
youtube_download_search_placeholder = nimi kalama, jan, poki, anu linja nimi…
youtube_download_search = o alasa
youtube_download_download_link = o kama jo e linja nimi
youtube_download_resolving_link = mi lukin e linja nimi…
youtube_download_link_detected = linja nimi li lon. ni li kama jo e kalama ni taso
youtube_download_error_link = mi ken ala lukin e linja nimi: { $error }
youtube_download_searching = mi alasa…
youtube_download_results = kama tan alasa
youtube_download_download = o kama jo
youtube_download_output_dir_placeholder = poki pi kama jo (poki kalama li nasin open)
youtube_download_pick_folder = o wile e poki
youtube_download_clear_history = o weka e sona pini
youtube_download_empty_state = o alasa e kalama, anu o pana e linja nimi YouTube
youtube_download_no_results = kalama ala li lon
youtube_download_jobs = kama jo
youtube_download_file_options = nasin ante pi lipu kalama
youtube_download_embed_metadata = o pana e sona lon insa
youtube_download_embed_metadata_desc = nimi, jan, poki, en linja nimi mama li awen lon insa pi lipu kalama
youtube_download_embed_thumbnail = o pana e sitelen poki lon insa
youtube_download_embed_thumbnail_desc = sina ken la ona li lon insa. sina ken ala la lipu JPG li lon poka
youtube_download_write_thumbnail = o awen e sitelen poki lon lipu ante
youtube_download_write_thumbnail_desc = lipu JPG li kama lon poka pi lipu kalama
youtube_download_organize_album = o nasin e ona kepeken poki
youtube_download_organize_album_desc = lipu kama jo li lon poki pi nimi poki
youtube_download_overwrite = o ante e lipu pi lon pini
youtube_download_overwrite_desc = lipu pi nimi sama li kama ante
youtube_download_ffmpeg_hint = kama jo pi kalama open li wile ala e ilo ante. ilo ffmpeg li wile taso tawa ante kalama, tawa sona, anu tawa sitelen poki lon insa.
youtube_download_format_original = kalama open
...
youtube_download_status_resolving = mi alasa e nasin kalama YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  tenpo awen { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = mi pali…
youtube_download_status_completed = pini
youtube_download_status_waiting = mi awen…
youtube_download_error_search = alasa li pakala: { $error }
youtube_download_error_ffmpeg_required = nasin ni li wile e ilo ffmpeg. o kama jo e ilo ffmpeg, anu o wile e kalama open e weka pi pana insa.
youtube_download_error_duplicate_active = kalama ni li kama jo lon tenpo ni.
youtube_download_error_output_not_directory = nasin ni li poki ala: { $path }
youtube_download_error_output_prepare = mi ken ala pali e poki: { $error }
youtube_download_error_output_not_writable = mi ken ala pana lon poki ni: { $path }
