...
youtube_download_title = YouTube İndirmeleri
youtube_download_subtitle = YouTube Music'te ada göre ara ya da bir bağlantı yapıştır, Kopuz ile indir
youtube_download_options = Seçenekler
youtube_download_search_placeholder = Şarkı adı, sanatçı veya albüm, ya da bir bağlantı yapıştır…
youtube_download_search = Ara
youtube_download_download_link = Bağlantıyı indir
youtube_download_resolving_link = Bağlantı okunuyor…
youtube_download_link_detected = Bağlantı algılandı, tam olarak o parçayı indirir
youtube_download_error_link = Bağlantı okunamadı: { $error }
youtube_download_searching = Aranıyor…
youtube_download_results = Arama sonuçları
youtube_download_download = İndir
youtube_download_output_dir_placeholder = Çıktı klasörü (varsayılan: müzik klasörü)
youtube_download_pick_folder = Klasör seç
youtube_download_clear_history = Geçmişi temizle
youtube_download_empty_state = Başlamak için bir şarkı ara ya da bir YouTube bağlantısı yapıştır
youtube_download_no_results = Şarkı bulunamadı
youtube_download_jobs = İndirmeler
youtube_download_file_options = Dosya seçenekleri
youtube_download_embed_metadata = Meta verileri göm
youtube_download_embed_metadata_desc = Başlık, sanatçı, albüm ve kaynak adresini ses dosyasına kaydet
youtube_download_embed_thumbnail = Kapak görselini göm
youtube_download_embed_thumbnail_desc = Biçim destekliyorsa göm, desteklemiyorsa yanına JPG olarak kaydet
youtube_download_write_thumbnail = Kapağı ayrıca kaydet
youtube_download_write_thumbnail_desc = İndirilen sesin yanına bir JPG yaz
youtube_download_organize_album = Albüme göre düzenle
youtube_download_organize_album_desc = İndirilenleri albüm adlı bir klasöre koy
youtube_download_overwrite = Var olan dosyaların üzerine yaz
youtube_download_overwrite_desc = Aynı ada sahip bir dosyayı değiştir
youtube_download_ffmpeg_hint = Orijinal indirmeler harici bir indirici istemez. ffmpeg yalnızca dönüştürme, meta veri veya gömülü kapak için gerekir.
youtube_download_format_original = Orijinal kalite
...
youtube_download_status_resolving = YouTube akışı çözümleniyor…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  kalan { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = İşleniyor…
youtube_download_status_completed = Tamamlandı
youtube_download_status_waiting = Bekliyor…
youtube_download_error_search = Arama başarısız: { $error }
youtube_download_error_ffmpeg_required = Bu biçim veya seçili dosya seçenekleri için ffmpeg gerekiyor. ffmpeg kurun ya da Orijinal kaliteyi seçip gömmeyi kapatın.
youtube_download_error_duplicate_active = Bu şarkı zaten indiriliyor.
youtube_download_error_output_not_directory = Çıktı yolu bir klasör değil: { $path }
youtube_download_error_output_prepare = Çıktı klasörü hazırlanamadı: { $error }
youtube_download_error_output_not_writable = Çıktı klasörü yazılabilir değil: { $path }
