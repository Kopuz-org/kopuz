...
server = Сервер
youtube_downloads = Завантаження
youtube_download_title = Завантаження з YouTube
youtube_download_subtitle = Шукайте в YouTube Music за назвою або вставте посилання, і завантажуйте через Kopuz
youtube_download_options = Параметри
youtube_download_search_placeholder = Назва, виконавець або альбом, чи вставте посилання…
youtube_download_search = Пошук
youtube_download_download_link = Завантажити за посиланням
youtube_download_resolving_link = Читаємо посилання…
youtube_download_link_detected = Виявлено посилання, буде завантажено саме цей трек
youtube_download_error_link = Не вдалося прочитати посилання: { $error }
youtube_download_searching = Шукаємо…
youtube_download_results = Результати пошуку
youtube_download_download = Завантажити
youtube_download_output_dir_placeholder = Тека призначення (типово тека з музикою)
youtube_download_pick_folder = Вибрати теку
youtube_download_clear_history = Очистити історію
youtube_download_empty_state = Знайдіть пісню, щоб почати, або вставте посилання на YouTube
youtube_download_no_results = Пісень не знайдено
youtube_download_jobs = Завантаження
youtube_download_file_options = Параметри файлу
youtube_download_embed_metadata = Вбудовувати метадані
youtube_download_embed_metadata_desc = Зберігати назву, виконавця, альбом і адресу джерела в аудіофайлі
youtube_download_embed_thumbnail = Вбудовувати обкладинку
youtube_download_embed_thumbnail_desc = Вбудовувати, якщо формат це підтримує, інакше зберігати JPG поруч
youtube_download_write_thumbnail = Зберігати обкладинку окремо
youtube_download_write_thumbnail_desc = Записувати JPG поруч із завантаженим аудіо
youtube_download_organize_album = Упорядковувати за альбомом
youtube_download_organize_album_desc = Складати завантаження в теку з назвою альбому
youtube_download_overwrite = Перезаписувати наявні файли
youtube_download_overwrite_desc = Замінювати файл із такою самою кінцевою назвою
youtube_download_ffmpeg_hint = Завантаження в оригінальній якості не потребують зовнішніх програм. ffmpeg потрібен лише для перетворення, метаданих чи вбудованої обкладинки.
youtube_download_format_original = Оригінальна якість
...
youtube_download_status_resolving = Отримуємо потік YouTube…
youtube_download_status_downloading_eta = { $percent }%  { $speed }  лишилось { $eta }
youtube_download_status_downloading = { $percent }%
youtube_download_status_processing = Обробка…
youtube_download_status_completed = Завершено
youtube_download_status_waiting = Очікування…
youtube_download_error_search = Пошук не вдався: { $error }
youtube_download_error_ffmpeg_required = Для цього формату або вибраних параметрів файлу потрібен ffmpeg. Встановіть ffmpeg або виберіть оригінальну якість і вимкніть вбудовування.
youtube_download_error_duplicate_active = Ця пісня вже завантажується.
youtube_download_error_output_not_directory = Шлях призначення не є текою: { $path }
youtube_download_error_output_prepare = Не вдалося підготувати теку призначення: { $error }
youtube_download_error_output_not_writable = До теки призначення не можна записувати: { $path }
