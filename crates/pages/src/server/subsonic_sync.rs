...
mod tests {
    ...
    #[test]
    fn encode_cover_url_tag_hex_encodes_full_url() {
        assert_eq!(
            encode_cover_url_tag("https://example.com/cover art.png"),
            "urlhex_68747470733a2f2f6578616d706c652e636f6d2f636f766572206172742e706e67"
        );
    }
}
