...
#[cfg(all(debug_assertions, not(any(target_arch = "wasm32", target_os = "android"))))]
fn debug_db_section() -> Element {
...
#[cfg(not(all(debug_assertions, not(any(target_arch = "wasm32", target_os = "android")))))]
fn debug_db_section() -> Element {
    rsx! {}
}
