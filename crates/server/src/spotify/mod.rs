...
//! plays without a Spotify Premium audio key. ([`stream`] holds the native
//! librespot download/decrypt + 30s-preview path, currently unwired — see its
//! module doc.) The `MediaSource` glue lives in [`crate::source`].
